...
public class ApiStorage implements IApiStorage {
    ...
    @Override
    public <Item extends RealmObject> Item getItem(Class<Item> objectClass, String idField, String id) {
        return getQuery(objectClass).equalTo(idField, id).findFirst();
    }
    ...
    @Override
    public <Item extends RealmObject> void setItem(Item item) {
